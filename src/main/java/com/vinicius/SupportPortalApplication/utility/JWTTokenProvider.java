package com.vinicius.SupportPortalApplication.utility;
...
import static com.vinicius.SupportPortalApplication.constant.SecurityConstant.*;
...
public class JWTTokenProvider {
    ...
    public String generateJwtToken(UserPrincipal userPrincipal) {
        ...
        return JWT.create().withIssuer(GET_ARRAYS_LLC).
                withAudience(GET_ARRAYS_ADMINSTATION)
    ...
    public boolean isTokenValed(String username, String token) {
